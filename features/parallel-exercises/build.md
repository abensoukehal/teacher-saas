...
## Local run — dedicated ports (slot 6)
...
| service | port | URL |
|---|---|---|
| backend | `9600` | http://localhost:9600/health |
| frontend | `10600` | http://localhost:10600/ |
...
- [ ] lane ports free (slot 6) · brief seeded with source anchor · state.json initialized
