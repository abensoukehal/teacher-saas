...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-09 05:44. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/parallel-exercises @ fe05184` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |
| fe | `feature/parallel-exercises @ 274c7d3` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |

- lane ports (slot 6): be :9600 free · fe :10600 free · 
