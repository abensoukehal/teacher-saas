...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-10 02:38. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/programme-corpus @ c8e8814` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |
| fe | `feature/programme-corpus @ f994678` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |

- lane ports (slot 7): be :9700 free · fe :10700 free · 
