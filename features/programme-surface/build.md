...
## Local run — dedicated ports (slot 9)
...
| service | port | URL |
|---|---|---|
| backend | `9900` | http://localhost:9900/health |
| frontend | `10900` | http://localhost:10900/ |
...
- [ ] lane ports free (slot 9) · brief seeded with source anchor · state.json initialized
