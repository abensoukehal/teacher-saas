...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-11 09:25. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/programme-surface @ 7c18729` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |
| fe | `feature/programme-surface @ 4df022b` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |

- lane ports (slot 9): be :9900 free · fe :10900 free · 
