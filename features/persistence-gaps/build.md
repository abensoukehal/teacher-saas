...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-08 00:43. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/persistence-gaps @ 4a34b62` | ✓ | ✗ | RED — record pre-existing reds (WF-50) |
| fe | `feature/persistence-gaps @ fa5d54b` | ✓ | ✗ | RED — record pre-existing reds (WF-50) |

- lane ports (slot 3): be :9300 free · fe :10300 free · 
