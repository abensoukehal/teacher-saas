...
## Local run — dedicated ports (slot 3)
...
| service | port | URL |
|---|---|---|
| backend | `9300` | http://localhost:9300/health |
| frontend | `10300` | http://localhost:10300/ |
...
- [ ] lane ports free (slot 3) · brief seeded with source anchor · state.json initialized
