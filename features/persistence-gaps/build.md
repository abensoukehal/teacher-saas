...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-08 01:08. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/persistence-gaps @ 4a34b62` | ✓ | ✗ | skipped (--no-ci) |
| fe | `feature/persistence-gaps @ fa5d54b` | ✓ | ✗ | skipped (--no-ci) |

- lane ports (slot 3): be :9300 in use · fe :10300 in use · 
