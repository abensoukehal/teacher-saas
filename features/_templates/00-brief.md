---
kind: feature              # feature | bugfix | hotfix | exploration | eval
...
source_url:                # REQUIRED (every job) — upstream anchor: tracker Project
                           # (feature) or Issue (bugfix/hotfix). Captured at PROVISION, never back-filled.
company_linear_id:         # the upstream id parsed from source_url (project or issue id)
slug:
date:
---
...
<!-- issue as he framed it -->

## How he thinks we should solve it

<!-- his proposed direction, even if it changes later -->
