...
## Local run — dedicated ports (slot 5)
...
| service | port | URL |
|---|---|---|
| backend | `9500` | http://localhost:9500/health |
| frontend | `10500` | http://localhost:10500/ |
...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-08 19:26. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/accounts-hardening @ 9b9f5ac` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |
| fe | `feature/accounts-hardening @ 6e28d5e` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |

- lane ports (slot 5): be :9500 free · fe :10500 free · 
