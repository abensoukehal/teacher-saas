...
## Local run — dedicated ports (slot 8)
...
| service | port | URL |
|---|---|---|
| backend | `9800` | http://localhost:9800/health |
| frontend | `10800` | http://localhost:10800/ |
...
- [ ] lane ports free (slot 8) · brief seeded with source anchor · state.json initialized
