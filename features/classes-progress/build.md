...
> GENERATED by tools/provision (create/verify/extend) — last run 2026-08-10 23:48. Base shas anchor
...
|---|---|---|---|---|
| be | `feature/classes-progress @ 169374d` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |
| fe | `feature/classes-progress @ f994678` | ✓ | ✗ | RED — no gate yet (expected on a fresh job) |

- lane ports (slot 8): be :9800 free · fe :10800 free · 
